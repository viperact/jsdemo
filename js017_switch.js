...
/*
    ...
    변수와 경우의 값에서 일치하는 값이 같이 있을 때, 그에 해당하는 실행문을 시행한다.
...
switch (code) {
  ...
  case "c300":
    console.log("생선류");
  //마지막 식에는 결과값이 일치한다면 다음 식이 없기때문에 break를 생략가능하다.
  //식의 결과값이 정해진것 , 맞아 떨어지는것들만 switch case 사용가능
}
